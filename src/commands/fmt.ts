...
import { FMT_PRESETS } from '../presets/registry.js'
import { logger } from '../utils/logger.js'
import { resolvePreset } from '../utils/errors.js'
import { generateAllFmt, type GenerateOptions } from '../generators/fmt.js'
import { detectPackageManager, installDevDeps, getRunPrefix } from '../utils/deps.js'
...
export function registerFmtCommand(program: Command) {
  ...
  fmt
    ...
    .action(async (presetName: string, options: { force?: boolean; install?: boolean; dryRun?: boolean }) => {
