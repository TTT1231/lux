 ...
 */
export function generateVscodeSettings(preset: VscodePreset, opts: GenerateOptions): boolean {
 ...
 */
export function generateVscodeExtensions(preset: VscodePreset, opts: GenerateOptions): boolean {
